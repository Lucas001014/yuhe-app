...
EXPO_DIR="expo"
EXPO_PORT="5000"
# 后端 API 地址（固定使用本地后端端口，不使用前端域名）
BACKEND_API_URL="http://127.0.0.1:${SERVER_PORT}"
WEB_URL="${COZE_PROJECT_DOMAIN_DEFAULT:-http://127.0.0.1:${EXPO_PORT}}"
ASSUME_YES="1"
# 后端 API 地址应该指向本地后端服务，而不是前端域名
EXPO_PUBLIC_BACKEND_BASE_URL="${BACKEND_API_URL}"
